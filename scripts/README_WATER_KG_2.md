...
```powershell
.\.venv\Scripts\python.exe .\scripts\raw_data_import.py
.\.venv\Scripts\python.exe .\scripts\water_kg_2_import.py
```
...
```powershell
.\.venv\Scripts\python.exe .\scripts\water_kg_2_import.py --rebuild
```
